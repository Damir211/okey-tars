...
var odometerContainer = document.querySelector('.drawnumber__end');
var nameContainer = document.querySelector('.drawnumber__name');
var resultsContainer = document.querySelector('.drawlist__container');
var odometerScript;
...
function setPhoneWinner(name, num, btn) {
  btn.classList.add('disabled');
  odometerScript.update(String(num));
  setTimeout(function () {
    nameContainer.innerText = name;
    resultsContainer.insertAdjacentHTML('beforeend', "<span>".concat(name, ", +7 \u0425\u0425\u0425 \u0425\u0425\u0425 ").concat(num.substr(0, 2), " ").concat(num.substr(2), "</span>"));
